...
export default function SiteRenamedTopNotice(props) {
    ...
    let gannotations = () => <> New Chrome extension is now available {' > '} <a target={"_blank"} style={{ color: 'white', textDecoration: 'underline' }} href="chrome://extensions/">Update to version 1.5.1</a> - {' '} </>;
