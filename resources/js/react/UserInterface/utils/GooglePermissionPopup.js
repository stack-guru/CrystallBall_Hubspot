...
export default class GooglePermissionPopup extends Component {
    ...
    handleLoad() {
        ...
        * */
        ...
        googlePermissionsHtml += '<label class="form-check-label" for="google_search_console_perm">Google Search Console </label><label class="badge badge-warning badge-sm float-left ml-2">Coming Soon</label>';
        googlePermissionsHtml += '</div>';
