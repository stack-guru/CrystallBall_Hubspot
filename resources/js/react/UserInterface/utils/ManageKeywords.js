...
export default class ManageKeywords extends React.Component {
    ...
    deleteKeyword(configuration_id,keyword_id) {
        ...
        if (keyword_id) {
            let params = {
                keyword_configuration_id: configuration_id,
    ...
    editKeyword(configuration_id,keyword_id) {
        this.props.editKeywordCallback(configuration_id, keyword_id);
    }
        ...
        let keywords = this.props.keywords.map(function (
            ...
            return keyword_instance.configurations.map(function (
                ...
                return (<div className="singleRow">
                    ...
                    <div className="singleCol colUrl text-left"><a href={configuration_instance.url} target="_blank" className="fa fa-link"></a></div>
                    ...
                    <div className="singleCol colAction text-right">
                        <a href="javascript:void(0);" onClick={() => this.editKeyword(configuration_instance.id,keyword_instance.id)} >
                        ...
                        <a href="javascript:void(0);" onClick={() => this.deleteKeyword(configuration_instance.id,keyword_instance.id)} >
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
