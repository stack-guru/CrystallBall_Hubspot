                    ...
                    <ModalBody style={{ padding: '3%' }}  >
                        <center id="scw-modal-body">
                            <div className="d-flex flex-column align-items-center gap-10">
                                <h1 className="text-primary"><strong>Hello Adil 👋</strong></h1>
                                ...
                                <p>
                                    Based on your website, we recommend you some steps to
                                    enhance your experience. You can see the checklist on left, and
                                    even if you cancel, you can resume the setup whenever you like
                                    from the header
                                </p>
                                <Button style={{ width: '140px' }} color="primary" onClick={() => { this.recordStepResponse('START', true); this.incrementStep(1) }} >Let's Go</Button>
                            </div>
                        </center>
                    </ModalBody>
                ];
