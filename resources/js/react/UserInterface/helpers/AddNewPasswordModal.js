    ...
    render() {
        ...
        return (
            <Modal className={`apps-modal md`} isOpen={this.props.show}>
                <ModalBody>
                    <div className="popupContent modal-setupNewPassword">
                                ...
                                <div className='my-4 d-flex gap-5 flex-column align-items-center'>
                                    <div className="form-group" style={{width: "70%"}}>
                                        <input type="text" autocomplete="off" className="form-control"
                                               value={this.state.user.name} onChange={this.changeHandler} id="name"
                                               name="name" placeholder='Full name'/>
                                        {validation.name ? <span
                                            className="bmd-help text-danger"> &nbsp; &nbsp;{validation.name}</span> : ''}
                                    </div>
                                    <div className="form-group" style={{width: "70%"}}>
                                        ...
                                        {validation.password ? <span
                                            className="bmd-help text-danger"> &nbsp; &nbsp;{validation.password}</span> : ''}
                                    </div>
                                    <div className="form-group" style={{width: "70%"}}>
                                        <input type="password" autocomplete="off" className="form-control"
                                        ...
                                        {validation.password_confirmation ? <span
                                            className="bmd-help text-danger"> &nbsp; &nbsp;{validation.password_confirmation}</span> : ''}
                                    </div>
                                </div>
