...
export default function ConsoleTopStatistics(props) {
    return (
                ...
                <div className={"w-100 report-box"}>
                    ...
                    <div className="fourGridBoxesHolder" style={{gap: '15px'}}>
                        <div className=" d-flex flex-column  w-100 box-color1">
                            {/* <span className="box-icon"> <img src="/images/svg/todays-expence-icon1.svg" alt="list icon" /></span> */}
                        ...
                        <div className="d-flex flex-column  w-100 box-color2">
                            {/* <span className="box-icon"> <img src="/images/svg/todays-expence-icon2.svg" alt="list icon" /></span> */}
                            <h2 className="box-headings"
                        ...
                        <div className="d-flex flex-column w-100 box-color3">
                            {/* <span className="box-icon"> <img src="/images/svg/todays-expence-icon3.svg" alt="list icon" /></span> */}
                        ...
                        <div className="d-flex flex-column w-100 box-color4">
                            {/* <span className="box-icon"> <img src="/images/svg/todays-expence-icon4.svg" alt="list icon" /></span> */}
        ...
        {/* <div id="mainContent" style={{ marginTop: '10px' }}>
