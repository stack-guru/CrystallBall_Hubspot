                                    ...
                                    <div className={`plan d-flex flex-column flex-grow-1 ${pricePlan.badge_text && 'bestplan'}`}>
                                        ...
                                        (pricePlan.twitter_credits_count == -1 || pricePlan.twitter_credits_count == null) ? null :   <div className='planfoot'>
                                            ...
                                            <ul>
                                                ...
                                                {pricePlan.youtube_credits_count == -1 || pricePlan.youtube_credits_count == null ? null : <li className='d-flex align-items-center'><i><img src={'/tick-green.svg'} /></i> <span>Youtube Monitors: {pricePlan.youtube_credits_count == 0 ? 'Unlimited' : pricePlan.youtube_credits_count}</span> </li>}
