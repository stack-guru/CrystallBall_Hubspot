                                            ...
                                            <tbody>
                                                {this.state.notification_settings.map(notificationSetting => {
                                                    return (<tr>
                                                        ...
                                                        <td className="border-right light-gray-border thin-border">{notificationSetting.email_on_event_day !== -1 ?<input name="email_on_event_day" notification-setting-id={notificationSetting.id} onChange={this.handleChange} type="checkbox" checked={notificationSetting.email_on_event_day} /> : null}</td>
                                                        ...
                                                        <td className="border-left light-gray-border thin-border">{notificationSetting.email_seven_days_before !== -1 ?<input name="email_seven_days_before" notification-setting-id={notificationSetting.id} onChange={this.handleChange} type="checkbox" checked={notificationSetting.email_seven_days_before} /> : null}</td>
                                                    </tr>)
                                                })}
                                            </tbody>
                                        </table>
