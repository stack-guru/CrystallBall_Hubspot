                    ...
                    <table aria-label="Payment History" class="table table-hover table-bordered " id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('admin.plan-notifications.destroy',$planNotification->id)}}" method="post" onsubmit="event.preventDefault(); if(confirm('Do you really want to delete this entity?')) this.submit();">
                                        @csrf
                                        @method('DELETE')
