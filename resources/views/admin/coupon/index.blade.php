                            ...
                            @forelse($coupons as $coupon)
                                <tr>
                                    ...
                                    <td class="d-flex flex-row">
                                        ...
                                        <form action="{{route('admin.coupon.destroy',$coupon->id)}}" method="post" onsubmit="event.preventDefault(); if(confirm('Do you really want to delete this entity?')) this.submit();">
                                            @csrf
                                            @method('DELETE')
