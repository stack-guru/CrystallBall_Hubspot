            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input  class="form-control" type="date" name="price_plan_expiry_date" id="pricePlanExpiryDate" value="{{ $user->price_plan_expiry_date?$user->price_plan_expiry_date->format('Y-m-d'):'' }}" >
                        </div>
                        <div class="form-group">
