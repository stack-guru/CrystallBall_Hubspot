...
<form class="form-signin" method="POST" action="{{ route('login') }}">
  ...
  <a class="minified-provider mt-3" href="{{ route('socialite.google') }}"><img class="oauth-logo" src="/images/google-logo.png"><span class="minified-provider-name">Sign in with Google</span></a>
