...
<div>
    ...
    <div>
        ...
        <div>
            <div>Create annotations for essential workspaces</div>
            <img src="/images/signup-slider-01.png" />
        </div>
        <div>
            <div>Insights - predictions</div>
            <img src="/images/signup-slider-02.png" />
        </div>
        <div>
            <div>Use AI and Google Analytics annotations to make more accurate predictions about your website's future performance</div>
