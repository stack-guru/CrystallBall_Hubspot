...
class CreateFacebookTrackingAnnotationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('facebook_tracking_annotations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('facebook_tracking_annotations');
    }
}
