...
class CreateChromeExtensionLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('chrome_extension_logs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('chrome_extension_logs');
    }
}
