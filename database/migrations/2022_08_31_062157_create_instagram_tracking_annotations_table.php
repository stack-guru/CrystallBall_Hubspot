...
class CreateInstagramTrackingAnnotationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('instagram_tracking_annotations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('instagram_tracking_annotations');
    }
}
