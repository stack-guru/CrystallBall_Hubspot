...
class CreateKeywordTrackingAnnotationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('keyword_tracking_annotations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('keyword_tracking_annotations');
    }
}
