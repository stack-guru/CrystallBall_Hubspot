...
class CreateGithubCommitAnnotationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('github_commit_annotations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('github_commit_annotations');
    }
}
