...
class ChecklistItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('checklist_items')->insert([
            ...
            ['name' => 'CONN_ADWORDS', 'label' => 'Connect with AdWords', 'description' => null, 'url' => '/integrations', 'sort_rank' => 90],
            ['name' => 'CONN_MAILCHIMP', 'label' => 'Connect with MailChimp', 'description' => null, 'url' => '/integrations', 'sort_rank' => 100],
            ['name' => 'CONN_SHOPIFY', 'label' => 'Connect with Shopify', 'description' => null, 'url' => '/integrations', 'sort_rank' => 110],
            ['name' => 'CONN_SLACK', 'label' => 'Connect with Slack', 'description' => null, 'url' => '/integrations', 'sort_rank' => 120],
            ['name' => 'CONN_ASANA', 'label' => 'Connect with Asana', 'description' => null, 'url' => '/integrations', 'sort_rank' => 130],
            ['name' => 'CONN_JIRA', 'label' => 'Connect with Jira', 'description' => null, 'url' => '/integrations', 'sort_rank' => 140],
            ['name' => 'CONN_TRELLO', 'label' => 'Connect with Trello', 'description' => null, 'url' => '/integrations', 'sort_rank' => 150],
            ['name' => 'CONN_GITHUB', 'label' => 'Connect with Github', 'description' => null, 'url' => '/integrations', 'sort_rank' => 160],
            ['name' => 'CONN_BITBUCKET', 'label' => 'Connect with Bitbucket', 'description' => null, 'url' => '/integrations', 'sort_rank' => 170],
            ['name' => 'CONN_GOOG_SHTS', 'label' => 'Connect with Google Sheets', 'description' => null, 'url' => '/integrations', 'sort_rank' => 180],
