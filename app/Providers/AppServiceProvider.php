    ...
    public function boot()
    {
        ...
        switch (request()->getHost()) {
            case 'app.gaannotations.com':
                config(['app.name' => 'GAannotations', 'app.url' => 'https://app.gaannotations.com', 'app.base_url' => 'https://www.gaannotations.com']);
            ...
            case 'app.crystalballinsight.com':
                config(['app.name' => 'Crystal Ball', 'app.url' => 'https://app.crystalballinsight.com', 'app.base_url' => 'https://www.crystalball.pro']);
            ...
            case 'localhost':
                config(['app.name' => 'GAannotations', 'app.url' => 'http://localhost', 'app.base_url' => 'https://www.gaannotations.com']);
                config(['app.icon' => asset('/favicon-gaa.ico'), 'app.logo' => asset('/images/company_logo_gaa.png')]);
                config(['mail.from' => ['address' => 'contact@gaannotations.com', 'name' => 'GAannotations']]);
                break;
