...
class AnnotationQueryHelper
{
    ...
    {
        $annotationsQuery = "";
        $annotationsQuery .= "select 1, update_date AS show_at, NULL, category, event_name, NULL as url, NULL as added_by, description, update_date from `google_algorithm_updates`";
