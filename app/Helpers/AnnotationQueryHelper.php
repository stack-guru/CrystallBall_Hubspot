...
class AnnotationQueryHelper
{
    ...
    {
        $annotationsQuery = "";
        $annotationsQuery .= "select 1, update_date AS show_at, NULL, category, event_name, NULL as url, CONCAT('google_algorithm_updates', '~~~~', `id`,  '~~~~', 'System', '~~~~', 'System') AS `added_by`, description, 'System' AS `user_name`, update_date, NULL AS `table_ga_property_id` from `google_algorithm_updates`";
