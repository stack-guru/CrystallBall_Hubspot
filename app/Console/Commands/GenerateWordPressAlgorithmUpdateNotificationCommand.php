...
class GenerateWordPressAlgorithmUpdateNotificationCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'gaa:generate-wordpress-algorithm-update-notification';
     ...
     * @var string
     */
    protected $description = 'This command will generate events if there is any wordpress algorithm update for users.';
